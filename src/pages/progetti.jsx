    ...
    return (
        <>
            ...
            <div className="py-10 " id="indice">
                <h1 className="text-center text-6xl md:text-8xl py-20 titolo-bianco">PROGETTI</h1>
                <hr className='mb-10' />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto justify-center align-middle items-stretch px-2" id='projects'>
                    {progetti.map((progetto, index) => (
                        <div key={index} className="flex flex-col gap-3">
                            <a href="" className="text-xl md:text-2xl text-center font-semibold">{progetto.title}</a>
...
// <SwiperSlide><img src="immagini\ANTEPRIME\AVEN.png"  alt=""  /></SwiperSlide>
// <SwiperSlide><img src="immagini\ANTEPRIME\BBS.png" alt="" /></SwiperSlide>
// <SwiperSlide><img src="immagini\ANTEPRIME\JDEAM.png" alt="" /></SwiperSlide>
// <SwiperSlide><img src="immagini\ANTEPRIME\SECONDLIFE.png" alt="" /></SwiperSlide>
// <SwiperSlide><img src="immagini\ANTEPRIME\VENDOR.png" alt="" /></SwiperSlide>