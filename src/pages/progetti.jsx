...
`
    ...
    let supabase = {
        name: "SUPABASE",
        svg: `<svg height="${h_icon}" width="${w_icon}" viewBox="0 0 109 113" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`
    ...
    let progetti = [
        ...
        // jstore
        {
            ...
            video: null,
            immagini: [
                '/immagini/JSTORE/ANTEPRIME/1.png',
                '/immagini/JSTORE/ANTEPRIME/2.png',
                '/immagini/JSTORE/ANTEPRIME/3.png',
                '/immagini/JSTORE/ANTEPRIME/4.png',
                '/immagini/JSTORE/ANTEPRIME/5.png',
                '/immagini/JSTORE/ANTEPRIME/6.png',
                '/immagini/JSTORE/ANTEPRIME/7.png',
            ],
            link: null
        },
        // jdeam2
