function CardAnteprimaProgetti({ title, description, imageUrl, link }) {
    return (
        <div className="group h-full flex flex-col relative overflow-hidden rounded-2xl  shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 card-sfondo-bianco glass">
                ...
                {link && (
                    <div className="absolute top-4 left-4 flex gap-1 group-hover:opacity-100 transition-opacity duration-300">
                        <a
                            ...
                            className="inline-flex items-center space-x-2 bg-black/70 text-white px-3 py-2  text-sm font-medium transition-all hover:scale-105 duration-300">
